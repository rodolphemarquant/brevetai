...
function Mazing(id) {
  ...
  this.mazeContainer.insertAdjacentElement("afterend", mazeOutputDiv); // activate control keys
...
Mazing.prototype.tryMoveHero = function (pos) {
  ...
  var nextStep = this.maze[pos].className; // before moving
